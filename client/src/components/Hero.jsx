    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden bg-grid">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            I architect scalable web applications from Lagos to the world. Currently transitioning from frontend mastery to full-stack depth.
          </motion.p>
          ...
          >
            <button className="px-8 py-4 bg-black dark:bg-white dark:text-black text-white rounded-full font-bold hover:scale-105 transition-transform">
              View Work
            </button>
      ...
      {/* Floating Glass Cards (The "Surprise") */}
      <motion.div 
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="space-y-1">
            <div className="h-1 w-32 bg-gray-200/20 rounded-full overflow-hidden">
              <motion.div animate={{ width: "85%" }} transition={{ duration: 2, delay: 1 }} className="h-full bg-blue-500" />
            </div>
            <span className="text-[10px] uppercase opacity-50 font-bold">Node.js Proficiency</span>
          </div>
        </div>
      </motion.div>
    </section>
