...
import { FiCopy, FiCheck, FiArrowUpRight, FiLinkedin, FiTwitter, FiGithub } from "react-icons/fi";
    ...
    <section id="contact" className="py-24 relative overflow-hidden bg-grid">
      <div className="container mx-auto px-6 text-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-8xl font-black dark:text-white mb-12 tracking-tighter leading-none">
            LET’S BUILD THE <br /> 
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            ...
            <motion.div 
              ...
              className="group relative p-[1px] rounded-2xl bg-gradient-to-r from-gray-200 to-gray-300 dark:from-white/10 dark:to-white/5 shadow-2xl"
            >
              <div className="bg-white dark:bg-[#0a0a0a] rounded-2xl px-8 py-6 flex items-center gap-6">
                ...
                <button 
                  ...
                  className="p-4 bg-gray-100 dark:bg-white/5 rounded-xl hover:bg-blue-600 hover:text-white transition-all relative"
                >
          ...
          <div className="mt-20 flex justify-center gap-8">
            {[
              ...
              <motion.a
                ...
                className="text-2xl text-gray-400 dark:text-gray-600 transition-colors"
              >
                {social.icon}
              </motion.a>
            ))}
